        ...
        <div class="container">
            <div class="header__logo">
                ...
                <div class="header__logo-btn" data-dropdown-btn="logo">
                    DevSpace<i class="icon-Arrow_Below"></i>
                </div>
            ...
            {{-- <div>
                <a href="" class="btn btn--type-02">Join Our Community</a>
            </div> --}}
            ...
            <div class="header__user">
                <div class="header__user-btn" data-dropdown-btn="user">
                    <img src="{{ asset('bootstrap-forum/fonts/icons/avatars/A.svg') }}" alt="avatar">
